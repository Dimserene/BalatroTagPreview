...
function create_UIBox_blind_tag(blind_choice, run_info)
  ...
  if (tag.name == 'Uncommon Tag' or tag.name == 'Rare Tag' or tag.name == 'Negative Tag' or tag.name == 'Foil Tag' or tag.name == 'Holographic Tag' or tag.name == 'Polychrome Tag' or tag.name == 'Glitter Tag' or tag.name == 'Fluorescent Tag') then
...
function add_card_to_tag(tag)
  ...
  elseif tag.name == 'Rare Tag' then
    ...
    elseif tag.name == 'Glitter Tag' then
      edition = { glitter = true }
    elseif tag.name == 'Fluorescent Tag' then
      edition = { fluorescent = true }
    end
...
function add_tag(_tag)
  ...
  if (_tag.name == 'Negative Tag' or _tag.name == 'Foil Tag' or _tag.name == 'Holographic Tag' or _tag.name == 'Polychrome Tag' or _tag.name == 'Glitter Tag' or _tag.name == 'Fluorescent Tag') then
  ...
  if not self.triggered and self.config.type == _context.type then
    ...
    elseif _context.type == 'store_joker_modify' then
      ...
      if not _context.card.ability.tag_joker and not _context.card.edition and not _context.card.temp_edition and _context.card.ability.set == 'Joker' then
        ...
        if (self.name == 'Foil Tag' or self.name == 'Holographic Tag' or self.name == 'Polychrome Tag' or self.name == 'Negative Tag' or self.name == 'Glitter Tag' or self.name == 'Fluorescent Tag') then
          if not self.replace_card then
            self = add_card_to_tag(self)
          end
          card_properties.eternal = self.replace_card.ability.eternal
          ...
          self:yep('+', G.C.DARK_EDITION, function()
            ...
            elseif self.name == 'Glitter Tag' then
              _context.card:set_edition({ glitter = true }, true)
            elseif self.name == 'Fluorescent Tag' then
              _context.card:set_edition({ fluorescent = true }, true)
            end
...
function Tag:get_uibox_table(tag_sprite)
  ...
  if tag_sprite.ability_UIBox_table then
    ...
    if (name_to_check == 'Uncommon Tag' or name_to_check == 'Rare Tag' or name_to_check == 'Negative Tag' or name_to_check == 'Foil Tag' or name_to_check == 'Holographic Tag' or name_to_check == 'Polychrome Tag' or name_to_check == 'Glitter Tag' or name_to_check == 'Fluorescent Tag') then
